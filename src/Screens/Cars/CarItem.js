...
const CarItem = ({ car, deleteCar, history, carId }) => (
   <div className="pt-card pt-elevation-0 pt-interactive car-item" onClick={e => {
      ...
      <p>Click to see more informations about this car ...</p>
   </div>
)
